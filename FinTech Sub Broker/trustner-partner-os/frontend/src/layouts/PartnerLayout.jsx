...
const navItems = [
  ...
  { label: 'My Clients', path: '/partner/clients', icon: UserCheck },
  { label: 'Transactions', path: '/partner/transactions', icon: CreditCard },
  { label: 'SIPs', path: '/partner/sips', icon: TrendingUp },
  { label: 'Commission', path: '/partner/commission', icon: IndianRupee },
  { label: 'Marketing', path: '/partner/marketing', icon: FileText },
