    ...
    <div className="border-b border-gray-100 bg-white">
      <div className="overflow-hidden" style={{ height: "46px" }}>
        <iframe
          ...
          title="Live Market Data - SENSEX, NIFTY, Gold, USD/INR"
          loading="eager"
          allowTransparency
        />
      </div>
