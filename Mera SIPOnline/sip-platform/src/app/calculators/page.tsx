...
import {
  ...
  GraduationCap, Gift, Sparkles, Microscope, ArrowLeftRight,
  Globe, Receipt, Percent, Building2, BarChart, Activity,
} from 'lucide-react';
...
const categories: Category[] = [
  {
    ...
    items: [
      ...
      {
        name: 'SWP + SIP Combo (Safety + Return)',
        description: 'Lumpsum in BAF → monthly SWP routed as SIP into Small Cap. The "safety bhi, return bhi" strategy.',
        href: '/calculators/swp-sip-combo',
        icon: TrendingUp,
        gradient: 'from-emerald-600 to-teal-700',
        bgLight: 'bg-emerald-50',
        textColor: 'text-emerald-700',
        tag: 'Trustner Signature',
      },
      {
      ...
      {
        name: 'Lifeline Investment Tool',
        description: 'Professional-grade tool — add SIPs, lump sums, withdrawals at any year.',
      ...
      {
        name: 'PSU Retirement Benefits Planner',
        description: 'Project total retirement corpus across PF, VPF, Gratuity, Leave Encashment, NPS & Pension — built for PSU and Govt employees.',
        href: '/calculators/psu-benefits',
        icon: Briefcase,
  ...
  },
  {
    ...
    items: [
      ...
      {
        name: 'PPF vs ELSS vs NPS (80C)',
        description: 'The honest Section 80C showdown. PPF (7.1%) vs ELSS (12%) vs NPS (10%) over 15-40 years — post-tax outcomes + Smart Mix.',
        href: '/calculators/ppf-vs-elss-vs-nps',
        icon: BarChart3,
        gradient: 'from-indigo-500 to-blue-600',
        bgLight: 'bg-indigo-50',
        textColor: 'text-indigo-600',
      ...
      {
        name: 'Home Loan Tax Shield',
        description: 'Year-by-year rupee tax saving on your home loan — Old vs New regime. Under New regime, self-occupied gets ZERO benefit.',
        href: '/calculators/home-loan-tax-shield',
        icon: Home,
        gradient: 'from-amber-500 to-orange-600',
        bgLight: 'bg-amber-50',
        textColor: 'text-amber-600',
      ...
      },
      {
        ...
        description: 'FY 2026-27 quarterly advance tax schedule — 15%/45%/75%/100% installments with 234B/234C interest for professionals & business owners.',
  ...
  },
  {
    ...
    items: [
      ...
      {
        name: 'Insurance IRR/XIRR Calculator',
        description: 'Decode what your life insurance policy is really yielding. Enter premium outflows, benefit inflows, and see the true IRR vs a Mutual Fund alternative.',
        href: '/calculators/insurance-irr',
        icon: Brain,
      ...
      {
        name: 'Surrender vs Continue Calculator',
        description: 'Mid-policy? See the rupee delta between surrendering now + investing in MF vs continuing premiums to maturity. Break-even IRR + verdict.',
        href: '/calculators/surrender-vs-continue',
        icon: ArrowLeftRight,
      ...
      {
        name: 'Mutual Fund vs ULIP Showdown',
        description: 'The honest 20-year comparison: ULIP charges vs MF + Term combo. See the exact rupee gap — usually ₹30-80L over 20 years.',
        href: '/calculators/mf-vs-ulip',
        icon: Scale,
        gradient: 'from-violet-500 to-purple-600',
        bgLight: 'bg-violet-50',
        textColor: 'text-violet-600',
      ...
      {
        name: 'ULIP IRR Analyzer',
        description: 'Decode what your ULIP actually earns after ALL charges — allocation, FMC, admin, mortality. Year-by-year NAV erosion with real IRR.',
        href: '/calculators/ulip-irr',
        icon: Microscope,
      ...
      {
        name: 'Critical Illness Cover Planner',
        description: 'The most underinsured risk in urban India. Size your CI cover based on treatment costs, income loss, and existing policies.',
        href: '/calculators/critical-illness',
        icon: Heart,
        gradient: 'from-rose-500 to-pink-600',
        bgLight: 'bg-rose-50',
        textColor: 'text-rose-600',
  ...
  },
  {
    ...
    subtitle: 'Build clear financial roadmaps for your child\'s education, marriage (son or daughter), and girl-child schemes',
    id: 'family',
    accentColor: 'from-rose-500 to-pink-700',
    items: [
      {
        name: 'Child Education Planner',
        description: 'Project future education cost (India/Abroad) with 9 stream presets — MBBS, IIT, IIM, US UG/PG — and find the monthly SIP needed. Now with fixed-₹ or % step-up.',
      ...
      },
      {
        ...
        description: 'Plan a wedding (son or daughter) with gold-inflation-aware projections. Split between Equity SIP and Sovereign Gold Bonds. Now with fixed-₹ or % step-up.',
      ...
      {
        name: 'Sukanya Samriddhi Yojana Planner',
        description: 'For girl child under 10 — project SSY corpus at 21 (and 18 for education), compare vs PPF + Equity MF, and see Sec 80C tax savings.',
        href: '/calculators/ssy-planner',
        icon: Sparkles,
        gradient: 'from-pink-500 to-rose-600',
        bgLight: 'bg-pink-50',
        textColor: 'text-pink-600',
  ...
  {
    title: 'Retirement & Post-Retirement',
    subtitle: 'Decumulation tools — architect your monthly income, withdrawal rate, and home-equity unlocks',
    id: 'retirement-post',
    accentColor: 'from-teal-500 to-cyan-700',
    items: [
      {
        name: 'Senior Citizen Income Architect',
        description: 'Auto-allocate retirement corpus across SCSS, POMIS, RBI Bonds, Tax-Free Bonds, FDs and MF SWP for maximum post-tax monthly income.',
        href: '/calculators/senior-income',
        icon: Landmark,
        gradient: 'from-teal-500 to-cyan-600',
        bgLight: 'bg-teal-50',
        textColor: 'text-teal-600',
      ...
      },
      {
        ...
        description: 'Turn home equity into monthly income without selling. Compare Reverse Mortgage Loan (RML) and RML-enabled Annuity (RMLeA) vs sell-and-SWP.',
      ...
      {
        name: 'Safe Withdrawal Rate (India)',
        description: 'India-calibrated SWR with Monte Carlo confidence intervals. The 4%-rule for 6% inflation and 12% equity — across 25-40 year horizons.',
      ...
      {
        name: 'Annuity Decoder',
        description: 'Decode immediate vs deferred, single vs joint, with/without Return of Purchase Price. See the IRR of each variant so ROP myth is exposed.',
  ...
  },
  {
    ...
    items: [
      ...
      {
        name: 'Real Estate Actual Return',
        description: 'The honest property IRR — stamp duty, interest, maintenance, brokerage, capital gains. Usually 4-7%, not the 10% you think.',
        href: '/calculators/real-estate-return',
        icon: Building2,
        gradient: 'from-amber-500 to-orange-600',
        bgLight: 'bg-amber-50',
        textColor: 'text-amber-600',
      ...
      },
      {
        ...
        description: 'Quantify portfolio drift, rupee-level rebalancing actions, and the tax-efficient sell sequence across Equity/Debt/Gold/Real Estate.',
        href: '/calculators/asset-rebalancer',
        icon: BarChart,
        gradient: 'from-indigo-500 to-blue-600',
        bgLight: 'bg-indigo-50',
        textColor: 'text-indigo-600',
  ...
  {
    title: 'NRI & Global',
    subtitle: 'NRI-specific tools for deposit comparison and cross-border money decisions',
    id: 'nri',
    accentColor: 'from-indigo-500 to-blue-700',
    items: [
      {
        name: 'NRE vs NRO vs FCNR Comparator',
        description: 'The 3-way NRI deposit decoder — post-tax returns, repatriation rules, and rupee depreciation modelled across tenures.',
        href: '/calculators/nre-nro-fcnr',
        icon: Globe,
        gradient: 'from-indigo-500 to-blue-600',
        bgLight: 'bg-indigo-50',
        textColor: 'text-indigo-600',
