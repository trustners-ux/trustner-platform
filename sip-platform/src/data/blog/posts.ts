...
export const blogPosts: BlogPost[] = [
  ...
  // ───────────────────────────── POST 88 ────────────────────────────
  // Behavioural finance — "boring is beautiful". Companion to the Issue 17
  // newsletter (week of 22-28 Jun 2026): a quiet, holiday-shortened week that
  // still drifted to a third straight gain with VIX at a 5-month low. Teaches
  // that wealth is built in the forgettable, uneventful weeks while compounding
  // works silently; the danger of needing the market to be "interesting"; why
  // "do something" is usually the wrong instinct; the boring-but-vital admin to
  // do in calm markets. MFD-compliant (Relationship Manager / mentor, never
  // advisor). Featured.
  {
    id: 'post-088',
    title: 'Boring Is Beautiful: Why the Quiet Weeks Build the Most Wealth',
    slug: 'boring-is-beautiful-why-quiet-weeks-build-the-most-wealth',
    excerpt:
    ...
    tags: ['boring investing', 'staying invested', 'low volatility', 'compounding', 'SIP discipline', 'behavioural finance', 'doing nothing', 'patience', 'long-term investing', 'goal-based investing', 'time in the market', 'market noise', 'India VIX', 'Relationship Manager', 'investor psychology', 'investor education'],
    content: [
      { type: 'paragraph', text: 'Some weeks in the market are simply uneventful. There is no dramatic rally to celebrate, no frightening crash to survive, no single headline that everyone is arguing about. The benchmarks dip a little, recover a little, and close more or less where a patient observer would have guessed — slightly higher, slightly lower, nothing to write home about. The fear gauge drifts near its lows. Nobody calls their Relationship Manager in a panic, because there is nothing to panic about. By the following Monday, the whole week has already been forgotten.' },
      { type: 'paragraph', text: 'It is tempting to treat a week like that as a non-event — as time the market "wasted" while it waited for something exciting to happen. That instinct is completely understandable, and it is also completely backwards. The quiet, forgettable weeks are not the gaps between the real action. For a long-term investor, they are the real action. They are where the actual work of wealth-building quietly gets done.' },
      { type: 'quote', text: 'Investing should be more like watching paint dry or watching grass grow. If you want excitement, take $800 and go to Las Vegas. — Paul Samuelson, Nobel laureate' },

      { type: 'heading', text: 'The week nothing happened — and why that was the point' },
      { type: 'paragraph', text: 'Consider a perfectly ordinary recent week. The market traded only a few sessions because of a holiday. It slipped on one day, recovered over the next two, and finished marginally higher — a third small weekly gain in a row. Volatility fell to a multi-month low. If you blinked, you missed it. There was no story to tell at the dinner table, no screenshot worth sharing, no reason to feel either thrilled or afraid.' },
      ...
      { type: 'paragraph', text: 'If you would like a calm, no-jargon review of whether your allocation, SIPs and nominations are all in good order — the kind of quiet housekeeping that quiet markets are perfect for — that is exactly the conversation we exist to have. Reach your Trustner Relationship Manager, or write to us.' },
    ...
    featured: true,
    coverGradient: 'from-slate-900 to-emerald-700',
  },

  // ───────────────────────────── POST 87 ────────────────────────────
  // Behavioural finance — every market fall needs a reason, and there is
  // always one; ~every few months the market finds a scare. The hindsight
  // asymmetry (2008 / 2020 felt like danger, look like gifts now), the cost
  // of watching the noise (BP + conviction + behaviour gap), roadblocks vs
  // goals, "you can't challenge the market — control allocation, fund quality,
  // behaviour, time". Companion to the volatile-week newsletter. MFD-compliant
  // (Relationship Manager / mentor, never advisor). Featured.
  {
    id: 'post-087',
    title: 'Every Market Fall Needs a Reason — and There Will Always Be One. Why Your Goals Are Bigger Than This Week’s Headline',
    slug: 'every-market-fall-needs-a-reason-focus-on-long-term-goals-not-noise',
    excerpt:
    ...
    content: [
      ...
      { type: 'paragraph', text: 'The next reason for a fall is already on its way; it always is, and it always will be. Your job is not to predict it or to fear it. Your job is to have an allocation and a plan robust enough that you simply do not need to. Keep your eyes on the goal, not on the ticker. The roadblocks will pass. The goal, if you let it, will not.' },
      { type: 'paragraph', text: 'If you would like a calm, no-jargon check of whether your allocation and funds are still on track for your goals — so the next correction is something you can ignore rather than fear — that is exactly the conversation we exist to have. Reach your Trustner Relationship Manager, or write to us.' },
    ...
    coverGradient: 'from-slate-900 to-sky-800',
  },

  // ───────────────────────────── POST 86 ────────────────────────────
  // Behavioural finance — the comparison trap. Built from a real (anonymised)
  // client conversation: 17%→13% falling XIRR, family at 4-13%, a colleague
  // claiming 18% "without an advisor". Teaches why returns are not comparable
  // across people, why a falling money-weighted return can hide a rising
  // fortune, the biases inside "my colleague got 18%", and the quiet full-time
  // value of an honest mentor. MFD-compliant (mentor/Relationship Manager, not
  // advisor). Featured.
  {
    id: 'post-086',
    title: 'From 17% to 13%: Why a Falling Return Can Hide a Growing Fortune — and the Comparison Trap a Good Mentor Saves You From',
    slug: 'comparison-trap-falling-returns-value-of-a-mentor-goal-based-investing',
    excerpt:
  ...
  // ───────────────────────────── POST 85 ────────────────────────────
  // DEEP STANDALONE companion to the "speed breakers" theme — a full,
  // source-verified history of Indian corporate blow-ups (Satyam → IL&FS →
  // DHFL → Gitanjali/PNB → Yes Bank → Rajesh Exports), the structural
  // shields that protect diversified investors, and the recovery record.
  // Evergreen educational deep-dive. MFD-compliant; Rajesh Exports framed
  // strictly as alleged/interim. Featured.
  {
    id: 'post-085',
    title: 'Anatomy of a Blow-Up: 17 Years of Indian Corporate Frauds — and Why the Diversified Investor Always Recovered',
    slug: 'anatomy-of-a-blow-up-indian-corporate-frauds-diversification-recovery',
    excerpt:
    ...
    content: [
      ...
      { type: 'heading', text: 'The Index Always Recovered — The Receipts' },
      { type: 'paragraph', text: 'A single company can go to zero and never come back. DHFL and Gitanjali equity were permanently extinguished; Yes Bank remains far below its 2018 peak. But the diversified index has recovered from every shock in its history. Here is the verified record of the three big drawdowns of the modern era:' },
      {
        type: 'table',
        rows: [
          ['Crash', 'How deep, and the low', 'Time to reclaim the prior peak'],
          ['2008 Global Financial Crisis', 'Sensex fell ~60% to ~8,160 (Mar 2009) from its Jan 2008 peak near 21,000', 'Reclaimed 21,000 by Nov 5, 2010 — about 20 months from the low'],
          ['2018 IL&FS / NBFC squeeze', 'Nifty corrected ~15% to about 10,000 (Oct 2018)', 'Back to new highs (12,000+) by mid-2019 — within months'],
          ['2020 COVID crash', 'Nifty fell ~38% in weeks to ~7,610 (Mar 23, 2020)', 'Back to its January 2020 peak by November 2020 — about 8 months'],
        ],
      },
      { type: 'paragraph', text: 'Now put the two facts side by side. On the day Satyam fell 78%, the Sensex fell 7.25% — and went on to recover. Over the year that Rajesh Exports fell about 50%, the Nifty 50 was down only about 5.7% — a normal, recoverable wobble. That gap between what happens to one fraudulent stock and what happens to the diversified index IS the proof of diversification. The stock is a roadblock; the index is merely a speed breaker.' },

      { type: 'heading', text: 'The Real Enemy Is Your Reaction, Not the Fraud' },
      { type: 'paragraph', text: 'Read the case histories carefully and a quieter pattern emerges: in every debt-fund episode, the worst realised losses came not from the default itself but from panic redemptions at the bottom. Investors who sold in fear crystallised losses; investors who stayed — and benefited from side-pockets and recoveries — preserved capital. The fraud was never the thing that hurt the diversified investor. The reaction was.' },
      { type: 'quote', text: 'The real key to making money in stocks is not to get scared out of them. — Peter Lynch' },
  ...
  // speed breakers, not roadblocks, for the diversified goal-based investor.
  {
    ...
    category: 'Market Analysis',
    readTime: '9 min read',
    tags: ['Rajesh Exports', 'Yes Bank', 'Satyam', 'IL&FS', 'DHFL', 'diversification', 'single-stock risk', 'goal-based investing', 'behavioural finance', 'SIP discipline', 'corporate governance', 'SEBI', 'mutual funds', 'June 2026', 'market commentary'],
    featured: false,
    coverGradient: 'from-slate-900 to-emerald-800',
    content: [
      { type: 'paragraph', text: 'On June 4-5, 2026, shares of Rajesh Exports — once one of India\'s largest gold and jewellery names by revenue — hit successive lower circuits after the market regulator, SEBI, barred its promoter and CEO Rajesh Mehta from the securities market. The allegation is staggering in scale: that the company misrepresented roughly ₹15.15 lakh crore of revenue across FY21 to FY25 (about 99.8% of the revenue reported by its subsidiaries), and that ₹338.9 crore of company funds were routed to accounts linked to the promoter, including for personal derivative trades. The stock is now down approximately 45% over six months and remains locked in lower circuits as we write.' },
      { type: 'paragraph', text: 'If you owned Rajesh Exports as a single stock — a "high-conviction bet," perhaps, from a friend\'s tip or a screener that loved its headline numbers — this is a wealth-destroying event you cannot trade your way out of, because a lower circuit means there are no buyers. If you are a diversified mutual-fund investor, this is simply a news item. Your funds, run by professional teams with forensic-accounting filters and position limits, almost certainly owned little or none of it. Your goals did not move an inch.' },
      { type: 'paragraph', text: 'Here is the most important thing we can tell you this week: this has happened before, it will happen again, and the disciplined investor has always come out fine. Let us show you the receipts.' },

      { type: 'heading', text: 'A Short, Honest History of Indian Corporate Blow-Ups' },
      { type: 'paragraph', text: 'Every few years, a celebrated company implodes — usually through fraud, governance failure, or reckless leverage. Each time, the financial press declares a crisis of confidence. And each time, the broad market absorbs the shock and moves on. Look at the pattern, not the panic:' },
      {
        type: 'table',
        rows: [
          ['Episode', 'Year', 'What happened to the stock', 'Nifty 50 ~12-24 months later'],
          ['Satyam Computer', 'Jan 2009', 'Chairman confessed to a ~₹7,000 cr fraud; stock collapsed ~80% in a single session', 'Nifty ~2,920 (Jan 2009) → ~5,200 by Dec 2009 (+~78%)'],
          ['IL&FS default', 'Sep 2018', 'AAA-rated lender defaulted; triggered the NBFC liquidity crisis', 'Nifty ~10,930 → ~11,900 within a year, then on to new highs'],
          ['DHFL', '2019', 'Housing-finance lender collapsed; equity all but wiped out, later delisted', 'Broad market dipped then recovered fully post-2020'],
          ['Yes Bank', 'Mar 2020', 'RBI moratorium; stock fell from ~₹400 (2018) to ~₹16 (-96% from peak)', 'Nifty ~7,610 (Mar 2020) → ~14,600 (Mar 2021), +~92%'],
          ['Rajesh Exports', 'Jun 2026', 'SEBI bars CEO over alleged ₹15.15 lakh cr misrepresentation; -45% in 6 months', 'Ongoing — diversified investors unaffected'],
        ],
      },
      { type: 'paragraph', text: 'Read that last column again. In every case, the index — and therefore the diversified, goal-based investor — not only survived the blow-up but went on to make new highs within roughly one to two years. The concentrated holder of the failed stock was devastated. The diversified holder barely felt it. Same market. Same news. Opposite outcomes. The only variable was diversification.' },

      { type: 'heading', text: 'Why Single-Stock Risk Is "Uncompensated"' },
      { type: 'paragraph', text: 'In finance, there are two kinds of risk. The first is market risk — the risk that the whole market falls because of interest rates, war, or a pandemic. You are paid to bear this risk over time; it is the source of the equity premium. The second is single-stock (or "idiosyncratic") risk — the risk that one specific company fails because of fraud, a bad product, or a reckless CEO. You are NOT paid extra to bear this risk, because it can be diversified away almost for free by simply owning many companies.' },
      { type: 'paragraph', text: 'That is the entire logic of a mutual fund. When you own a diversified equity fund holding 40-60 stocks, no single fraud can take down more than a percent or two of your money. A fund manager who had even 2% in Rajesh Exports would see the portfolio dip by less than 1% after a 45% crash — a rounding error against a multi-year compounding journey. The investor who had 30% of their savings in that one stock saw nearly 14% of their net worth evaporate, with no exit. Diversification is, as the old line goes, the only free lunch in investing.' },
      {
        type: 'piechart',
        chartData: [
          { label: 'Diversified fund: max damage from one fraud (~1-2%)', value: 2, color: '#10b981' },
          { label: 'Rest of the portfolio — untouched, still compounding', value: 98, color: '#0c4a6e' },
        ],
      },
      { type: 'paragraph', text: 'The chart above is the whole argument in one picture. A single-stock fraud in a diversified fund is the thin sliver. The same fraud in a concentrated portfolio can be the whole pie. You do not need to predict which company will be the next Satyam or Yes Bank — that is impossible, even for forensic experts. You only need to make sure that when it happens (and it will), it is a sliver and not the pie.' },

      { type: 'quote', text: 'Only when the tide goes out do you discover who has been swimming naked. — Warren Buffett' },
      { type: 'paragraph', text: 'Buffett\'s famous line is really about leverage and governance. Frauds and over-leveraged businesses look fine while markets rise; it is in the stress that they are exposed. You cannot reliably spot them in advance — Satyam was a darling of analysts, IL&FS was AAA-rated, Yes Bank was a private-banking poster child. The defence is not better stock-picking. The defence is structure: diversification, professional management, and a plan anchored to your goals rather than to any one ticker.' },

      { type: 'heading', text: 'The Real Enemy Is Not the Fraud. It Is Your Reaction To It.' },
      { type: 'paragraph', text: 'Here is the subtle danger of weeks like this. The Rajesh Exports headline is frightening, and fear is contagious. The temptation is to conclude "the market is rigged" or "equities are unsafe" and to stop your SIP or pull money out. That reaction — not the fraud itself — is what actually damages the diversified investor. The fraud never touched your funds. Panic-selling a diversified portfolio because one unrelated company committed fraud is like selling your house because your neighbour\'s car was stolen.' },
      { type: 'quote', text: 'The real key to making money in stocks is not to get scared out of them. — Peter Lynch' },
  ...
  // ───────────────────────────── POST 83 ────────────────────────────
  // Companion to Issue 13 newsletter (no longer featured).
  // Banking sector flat 18-20 months; what history says; is this permanent.
  {
    id: 'post-083',
    title: 'Bank Nifty Has Been Flat For 18 Months. Is The Banking Story Broken? History Has An Answer.',
    slug: 'bank-nifty-18-month-flat-cycle-historical-recovery-india',
    excerpt:
