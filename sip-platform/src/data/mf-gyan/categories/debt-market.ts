  ...
  topics: [
    ...
    /* ───────────────────────── 9. Long Term Debt Funds ───────────────────────── */
    {
      ...
      content: [
        ...
        "Priya's framing for Trustner clients is nuanced: \"Long-term debt funds are excellent when the rate cycle is in your favor — and right now, the wind is favourable. But they are tactical, not permanent, holdings. Keep your core debt allocation in shorter-duration or target maturity funds, and use long-term debt funds as a 20-30% satellite allocation when the rate-cut outlook is supportive. And always have a 3+ year horizon for the tax efficiency benefit.\"",
      ],
      keyTakeaways: [
