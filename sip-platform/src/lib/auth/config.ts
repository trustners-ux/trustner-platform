...
export const ADMIN_NAV = [
  ...
  { label: 'Research Stats Upload', href: '/admin/funds/research-stats-upload', icon: 'Database', role: 'editor' as AdminRole },
  ...
  { label: 'Trail Income', href: '/admin/mis/trails', icon: 'TrendingUp', role: 'hr' as AdminRole },
  { label: 'Partners', href: '/admin/mis/partners', icon: 'Shield', role: 'admin' as AdminRole },
  { label: 'Payouts', href: '/admin/mis/payouts', icon: 'Percent', role: 'admin' as AdminRole },
  { label: 'Payout Approvals', href: '/admin/mis/approvals', icon: 'ShieldCheck', role: 'hr' as AdminRole },
  { label: 'Motor Calc', href: '/admin/mis/motor', icon: 'Car', role: 'hr' as AdminRole },
