    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="py-16">
        <div className="container-custom">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={idx} className="bg-white p-4 rounded-lg border border-gray-200 flex items-start gap-4">
                    <div className="bg-blue-100 rounded-lg p-2 text-center min-w-[80px]">
          ...
          {/* CTA */}
          <div className="mt-16 bg-gradient-to-br from-blue-900 to-indigo-900 rounded-2xl p-8 text-center text-white">
            ...
            <Link href="/contact" className="inline-flex items-center gap-2 bg-white text-blue-900 px-8 py-3 rounded-lg font-semibold hover:bg-blue-50 transition-colors">
